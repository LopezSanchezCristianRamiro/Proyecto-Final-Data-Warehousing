...
package proyectofinal.dimtiempodm_0_1;
 ...
 * @status
 */
public class dimTiempoDM implements TalendJob {
	...
	private final String jobName = "dimTiempoDM";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimTiempoDM.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class tiempoStruct implements routines.system.IPersistableRow<tiempoStruct> {
		final static byte[] commonByteArrayLock_PROYECTOFINAL_dimTiempoDM = new byte[0];
		static byte[] commonByteArray_PROYECTOFINAL_dimTiempoDM = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final tiempoStruct other = (tiempoStruct) obj;
		...
		public void copyDataTo(tiempoStruct other) {
		...
		public void copyKeysDataTo(tiempoStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROYECTOFINAL_dimTiempoDM) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:4rt+F5GYomKEw55nhgwc9kfEC4zE1K7+dyZmgiYJIffNcQF/");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("FECHA");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("FECHA");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (ID,DIA,MES,ANIO) VALUES (?,?,?,?)";
...
// # Outputs initialization
				tiempoStruct tiempo_tmp = new tiempoStruct();
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:CX0JoTKjmep9F5xIFTOdpKpeq3KI8zMnQJ0QE/zrhnWy/MuN");
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (rs_tDBInput_1.getObject(2) != null) {
								row1.DIA = rs_tDBInput_1.getInt(2);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (rs_tDBInput_1.getObject(3) != null) {
								row1.MES = rs_tDBInput_1.getInt(3);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (rs_tDBInput_1.getObject(4) != null) {
								row1.ANIO = rs_tDBInput_1.getInt(4);
							} else {
...
// # Output table : 'tiempo'
							tiempo_tmp.ID = row1.ID;
							tiempo_tmp.DIA = row1.DIA;
							tiempo_tmp.MES = row1.MES;
							tiempo_tmp.ANIO = row1.ANIO;
							tiempo = tiempo_tmp;
// ###############################
...
// ###############################      
	...
	public static void main(String[] args) {
		final dimTiempoDM dimTiempoDMClass = new dimTiempoDM();

		int exitCode = dimTiempoDMClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimTiempoDM.class.getClassLoader()
					.getResourceAsStream("proyectofinal/dimtiempodm_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimTiempoDM.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimTiempoDM");
		}
...
/************************************************************************************************
 * 57546 characters generated by Talend Open Studio for Data Integration on the
 * 15 de junio de 2024, 0:42:31 BOT
 ************************************************************************************************/