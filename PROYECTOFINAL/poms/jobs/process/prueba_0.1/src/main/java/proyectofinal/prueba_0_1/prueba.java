...
package proyectofinal.prueba_0_1;
...
public class prueba implements TalendJob {
	...
	private final String projectName = "PROYECTOFINAL";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(prueba.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ventasStruct implements routines.system.IPersistableRow<ventasStruct> {
		final static byte[] commonByteArrayLock_PROYECTOFINAL_prueba = new byte[0];
		static byte[] commonByteArray_PROYECTOFINAL_prueba = new byte[0];
		...
		public int ID_METODOENVIO;

		public int getID_METODOENVIO() {
			return this.ID_METODOENVIO;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROYECTOFINAL_prueba) {
				...
				try {
					...
					this.ID_METODOENVIO = dis.readInt();

					this.ID_SEGMENTO = dis.readInt();

					this.ID_CLIENTE = dis.readInt();

					this.CANTVENTAS = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.ID_METODOENVIO);

				// int

				dos.writeInt(this.ID_SEGMENTO);
				...
				writeInteger(this.CANTVENTAS, dos);
		...
		public String toString() {
			...
			sb.append(",ID_METODOENVIO=" + String.valueOf(ID_METODOENVIO));
			sb.append(",ID_SEGMENTO=" + String.valueOf(ID_SEGMENTO));
			sb.append(",ID_CLIENTE=" + String.valueOf(ID_CLIENTE));
			sb.append(",CANTVENTAS=" + String.valueOf(CANTVENTAS));
		 ...
		 * Compare keys
		 */
		public int compareTo(ventasStruct other) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ventasStruct ventas = new ventasStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "ventas");
				}
				...
				String dbUser_tDBOutput_1 = "dmCaniador";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Xkqxmfh3ahCJZ+4M8B0+Vyb1fLZYuykKHYKsymK1cEVK2yK0");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("VENTAS");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("VENTAS");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (ID_TIEMPO,ID_PRODUCTO,ID_METODOENVIO,ID_SEGMENTO,ID_CLIENTE,CANTVENTAS,PRECIO) VALUES (?,?,?,?,?,?,?)";
...
// # Outputs initialization
				ventasStruct ventas_tmp = new ventasStruct();
// ###############################
				...
				String dbUser_tDBInput_1 = "stCaniador";

				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ODyElZKYVSUN3YURNjFYnTnUATTccY4VrxhI95Ep096ZrB85");
				...
				String dbquery_tDBInput_1 = "SELECT \n  STCANIADOR.VENTAS.ID_TIEMPO, \n  STCANIADOR.VENTAS.ID_PRODUCTO, \n  STCANIADOR.VENTAS.ID_METODOENVIO, \n  STCANI"
						+ "ADOR.VENTAS.ID_SEGMENTO, \n  STCANIADOR.VENTAS.ID_CLIENTE, \n  STCANIADOR.VENTAS.CANTVENTAS, \n  STCANIADOR.VENTAS.PRECIO\nF"
						+ "ROM STCANIADOR.VENTAS";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row1.ID_TIEMPO = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (rs_tDBInput_1.getObject(2) != null) {
								row1.ID_PRODUCTO = rs_tDBInput_1.getInt(2);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							row1.ID_METODOENVIO = 0;
						} else {

							if (rs_tDBInput_1.getObject(3) != null) {
								row1.ID_METODOENVIO = rs_tDBInput_1.getInt(3);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (rs_tDBInput_1.getObject(4) != null) {
								row1.ID_SEGMENTO = rs_tDBInput_1.getInt(4);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							if (rs_tDBInput_1.getObject(5) != null) {
								row1.ID_CLIENTE = rs_tDBInput_1.getInt(5);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							row1.CANTVENTAS = null;
						} else {

							if (rs_tDBInput_1.getObject(6) != null) {
								row1.CANTVENTAS = rs_tDBInput_1.getInt(6);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (rs_tDBInput_1.getObject(7) != null) {
								row1.PRECIO = rs_tDBInput_1.getBigDecimal(7);
							} else {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row2__ID = row1.ID_METODOENVIO;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row3__ID = row1.ID_TIEMPO;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row4__ID = row1.ID_CLIENTE;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row5__ID = row1.ID_SEGMENTO;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row6__ID = row1.ID_PRODUCTO;
...
// # Output table : 'ventas'
							ventas_tmp.ID_TIEMPO = row1.ID_TIEMPO;
							ventas_tmp.ID_PRODUCTO = row1.ID_PRODUCTO;
							ventas_tmp.ID_METODOENVIO = row1.ID_METODOENVIO;
							ventas_tmp.ID_SEGMENTO = row1.ID_SEGMENTO;
							ventas_tmp.ID_CLIENTE = row1.ID_CLIENTE;
							ventas_tmp.CANTVENTAS = row1.CANTVENTAS;
							ventas_tmp.PRECIO = row1.PRECIO;
							ventas = ventas_tmp;
// ###############################
...
// Start of branch "ventas"
						if (ventas != null) {
							...
							pstmt_tDBOutput_1.setInt(1, ventas.ID_TIEMPO);

							pstmt_tDBOutput_1.setInt(2, ventas.ID_PRODUCTO);

							pstmt_tDBOutput_1.setInt(3, ventas.ID_METODOENVIO);

							pstmt_tDBOutput_1.setInt(4, ventas.ID_SEGMENTO);

							pstmt_tDBOutput_1.setInt(5, ventas.ID_CLIENTE);

							if (ventas.CANTVENTAS == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(6, ventas.CANTVENTAS);
							}

							pstmt_tDBOutput_1.setBigDecimal(7, ventas.PRECIO);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "ventas");
				}
	...
	public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.CODCLIENTE = readString(dis, ois);

				this.NOMBRECLIENTE = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.CODCLIENTE = readString(dis, objectIn);

				this.NOMBRECLIENTE = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.CODCLIENTE, dos, oos);

				writeString(this.NOMBRECLIENTE, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.CODCLIENTE, dos, objectOut);

				writeString(this.NOMBRECLIENTE, dos, objectOut);
		...
		public String toString() {
			...
			sb.append(",CODCLIENTE=" + CODCLIENTE);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row4,row3,row2,row6,row5) outputs:(ventas)
				...
				url_tDBInput_2 = "jdbc:oracle:thin:@" + "localhost" + ":" + "1521" + ":" + "xe";

				String dbUser_tDBInput_2 = "stCaniador";

				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:p2KnWaOp2h/defmyPn2Or6OC5TN41nuR+EUpyXl4fPrqFCnR");
				...
				String dbquery_tDBInput_2 = "SELECT \n  STCANIADOR.CLIENTE.\"ID\", \n  STCANIADOR.CLIENTE.CODCLIENTE, \n  STCANIADOR.CLIENTE.NOMBRECLIENTE\nFROM STCANIA"
						+ "DOR.CLIENTE";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							row4.CODCLIENTE = null;
						} else {

							row4.CODCLIENTE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							row4.NOMBRECLIENTE = null;
						} else {

							row4.NOMBRECLIENTE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
						...
						row4_HashRow.CODCLIENTE = row4.CODCLIENTE;

						row4_HashRow.NOMBRECLIENTE = row4.NOMBRECLIENTE;
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.DIA = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.DIA, dos, objectOut);
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				url_tDBInput_4 = "jdbc:oracle:thin:@" + "localhost" + ":" + "1521" + ":" + "xe";

				String dbUser_tDBInput_4 = "stCaniador";

				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:nmPYoqaouOFRuznjO+1nG4dr54RqAvgruwTueTe9E0NZ5R3p");
				...
				if (!(conn_tDBInput_4 instanceof oracle.jdbc.OracleConnection)
					...
					if (conn_tDBInput_4.unwrap(oracle.jdbc.OracleConnection.class) != null) {
						((oracle.jdbc.OracleConnection) conn_tDBInput_4.unwrap(oracle.jdbc.OracleConnection.class))
				...
				String dbquery_tDBInput_4 = "SELECT \n  STCANIADOR.FECHA.\"ID\", \n  STCANIADOR.FECHA.DIA, \n  STCANIADOR.FECHA.MES, \n  STCANIADOR.FECHA.ANIO\nFROM STCA"
						+ "NIADOR.FECHA";
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							if (rs_tDBInput_4.getObject(2) != null) {
								row3.DIA = rs_tDBInput_4.getInt(2);
							} else {
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							if (rs_tDBInput_4.getObject(3) != null) {
								row3.MES = rs_tDBInput_4.getInt(3);
							} else {
						...
						if (colQtyInRs_tDBInput_4 < 4) {
							...
							if (rs_tDBInput_4.getObject(4) != null) {
								row3.ANIO = rs_tDBInput_4.getInt(4);
							} else {
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public String NOMBREMETODOENVIO;

		public String getNOMBREMETODOENVIO() {
			return this.NOMBREMETODOENVIO;
		}
		...
		public void copyDataTo(row2Struct other) {
			...
			other.ID = this.ID;
			other.NOMBREMETODOENVIO = this.NOMBREMETODOENVIO;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.NOMBREMETODOENVIO = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.NOMBREMETODOENVIO = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.NOMBREMETODOENVIO, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.NOMBREMETODOENVIO, dos, objectOut);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",NOMBREMETODOENVIO=" + NOMBREMETODOENVIO);
			sb.append("]");
	...
	public void tDBInput_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				url_tDBInput_7 = "jdbc:oracle:thin:@" + "localhost" + ":" + "1521" + ":" + "xe";

				String dbUser_tDBInput_7 = "stCaniador";

				final String decryptedPassword_tDBInput_7 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kIpoVMncOmwpuP0aHdQxUAuJ+FE7otBuHzUra3xW5EakxWxL");
				...
				if (!(conn_tDBInput_7 instanceof oracle.jdbc.OracleConnection)
					...
					if (conn_tDBInput_7.unwrap(oracle.jdbc.OracleConnection.class) != null) {
						((oracle.jdbc.OracleConnection) conn_tDBInput_7.unwrap(oracle.jdbc.OracleConnection.class))
				...
				String dbquery_tDBInput_7 = "SELECT \n  STCANIADOR.METODOENVIO.\"ID\", \n  STCANIADOR.METODOENVIO.NOMBREMETODOENVIO\nFROM STCANIADOR.METODOENVIO";
					...
					while (rs_tDBInput_7.next()) {
						...
						if (colQtyInRs_tDBInput_7 < 1) {
							...
							if (rs_tDBInput_7.getObject(1) != null) {
								row2.ID = rs_tDBInput_7.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_7 < 2) {
							row2.NOMBREMETODOENVIO = null;
						} else {

							row2.NOMBREMETODOENVIO = routines.system.JDBCUtil.getString(rs_tDBInput_7, 2, false);
						}
						...
						row2_HashRow.NOMBREMETODOENVIO = row2.NOMBREMETODOENVIO;
	...
	public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
		...
		public void copyDataTo(row6Struct other) {
			...
			other.ID = this.ID;
			other.CODPRODUCTO = this.CODPRODUCTO;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.CODPRODUCTO = readString(dis, ois);

				this.NOMBREPRODUCTO = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.CODPRODUCTO = readString(dis, objectIn);

				this.NOMBREPRODUCTO = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.CODPRODUCTO, dos, oos);

				writeString(this.NOMBREPRODUCTO, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.CODPRODUCTO, dos, objectOut);

				writeString(this.NOMBREPRODUCTO, dos, objectOut);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",CODPRODUCTO=" + CODPRODUCTO);
	...
	public void tDBInput_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_11 - inputs:(after_tDBInput_1) outputs:(row6,row6) |
				...
				url_tDBInput_11 = "jdbc:oracle:thin:@" + "localhost" + ":" + "1521" + ":" + "xe";

				String dbUser_tDBInput_11 = "stCaniador";

				final String decryptedPassword_tDBInput_11 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Ymvrokz3gjcSJJ7s8Qm1LYNnE+kMbR2sDhARBxJNmZrm6y3x");
				...
				java.sql.ResultSet rsGetTZ_tDBInput_11 = stmtGetTZ_tDBInput_11
						.executeQuery("select sessiontimezone from dual");
				...
				if (!(conn_tDBInput_11 instanceof oracle.jdbc.OracleConnection)
					...
					if (conn_tDBInput_11.unwrap(oracle.jdbc.OracleConnection.class) != null) {
						((oracle.jdbc.OracleConnection) conn_tDBInput_11.unwrap(oracle.jdbc.OracleConnection.class))
								.setSessionTimeZone(sessionTimezone_tDBInput_11);
					}
				} else {
				...
				String dbquery_tDBInput_11 = "SELECT \n  STCANIADOR.PRODUCTO.\"ID\", \n  STCANIADOR.PRODUCTO.CODPRODUCTO, \n  STCANIADOR.PRODUCTO.NOMBREPRODUCTO\nFROM ST"
						+ "CANIADOR.PRODUCTO";
					...
					while (rs_tDBInput_11.next()) {
						...
						if (colQtyInRs_tDBInput_11 < 1) {
							...
							if (rs_tDBInput_11.getObject(1) != null) {
								row6.ID = rs_tDBInput_11.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_11 < 2) {
							row6.CODPRODUCTO = null;
						} else {

							row6.CODPRODUCTO = routines.system.JDBCUtil.getString(rs_tDBInput_11, 2, false);
						}
						if (colQtyInRs_tDBInput_11 < 3) {
							row6.NOMBREPRODUCTO = null;
						} else {

							row6.NOMBREPRODUCTO = routines.system.JDBCUtil.getString(rs_tDBInput_11, 3, false);
						}
						...
						row6_HashRow.CODPRODUCTO = row6.CODPRODUCTO;

						row6_HashRow.NOMBREPRODUCTO = row6.NOMBREPRODUCTO;
	...
	public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
		...
		public void copyDataTo(row5Struct other) {
			...
			other.ID = this.ID;
			other.NOMBRESEGMENTO = this.NOMBRESEGMENTO;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.NOMBRESEGMENTO = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.NOMBRESEGMENTO = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.NOMBRESEGMENTO, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.NOMBRESEGMENTO, dos, objectOut);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",NOMBRESEGMENTO=" + NOMBRESEGMENTO);
			sb.append("]");
	...
	public void tDBInput_16Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_16 - inputs:(after_tDBInput_1) outputs:(row5,row5) |
				...
				String driverClass_tDBInput_16 = "oracle.jdbc.OracleDriver";
				java.lang.Class.forName(driverClass_tDBInput_16);

				String url_tDBInput_16 = null;
				url_tDBInput_16 = "jdbc:oracle:thin:@" + "localhost" + ":" + "1521" + ":" + "xe";

				String dbUser_tDBInput_16 = "stCaniador";

				final String decryptedPassword_tDBInput_16 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:2w2MGwvjKu62sjvJilGSEU4ebwPpVTB4NBQxKGxhbsx+Abjv");
				...
				conn_tDBInput_16 = java.sql.DriverManager.getConnection(url_tDBInput_16, dbUser_tDBInput_16,
						dbPwd_tDBInput_16);
				java.sql.Statement stmtGetTZ_tDBInput_16 = conn_tDBInput_16.createStatement();
				java.sql.ResultSet rsGetTZ_tDBInput_16 = stmtGetTZ_tDBInput_16
						.executeQuery("select sessiontimezone from dual");
				String sessionTimezone_tDBInput_16 = java.util.TimeZone.getDefault().getID();
				while (rsGetTZ_tDBInput_16.next()) {
					sessionTimezone_tDBInput_16 = rsGetTZ_tDBInput_16.getString(1);
				}
				if (!(conn_tDBInput_16 instanceof oracle.jdbc.OracleConnection)
						&& conn_tDBInput_16.isWrapperFor(oracle.jdbc.OracleConnection.class)) {
					if (conn_tDBInput_16.unwrap(oracle.jdbc.OracleConnection.class) != null) {
						((oracle.jdbc.OracleConnection) conn_tDBInput_16.unwrap(oracle.jdbc.OracleConnection.class))
								.setSessionTimeZone(sessionTimezone_tDBInput_16);
					}
				} else {
					((oracle.jdbc.OracleConnection) conn_tDBInput_16).setSessionTimeZone(sessionTimezone_tDBInput_16);
				}

				java.sql.Statement stmt_tDBInput_16 = conn_tDBInput_16.createStatement();

				String dbquery_tDBInput_16 = "SELECT \n  STCANIADOR.SEGMENTO.\"ID\", \n  STCANIADOR.SEGMENTO.NOMBRESEGMENTO\nFROM STCANIADOR.SEGMENTO";
					...
					while (rs_tDBInput_16.next()) {
						...
						if (colQtyInRs_tDBInput_16 < 1) {
							...
							if (rs_tDBInput_16.getObject(1) != null) {
								row5.ID = rs_tDBInput_16.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_16 < 2) {
							row5.NOMBRESEGMENTO = null;
						} else {

							row5.NOMBRESEGMENTO = routines.system.JDBCUtil.getString(rs_tDBInput_16, 2, false);
						}
						...
						row5_HashRow.NOMBRESEGMENTO = row5.NOMBRESEGMENTO;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = prueba.class.getClassLoader()
					.getResourceAsStream("proyectofinal/prueba_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = prueba.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : prueba");
		}
...
/************************************************************************************************
 * 171778 characters generated by Talend Open Studio for Data Integration on the
 * 15 de junio de 2024, 0:44:55 BOT
 ************************************************************************************************/